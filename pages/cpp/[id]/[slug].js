...
import CommuniqueSingle from "../../../components/elements/CommuniqueSingle";
// Import from Next
...
function PageCommuniqueSingle({ Communique, Designers, Section_Libres }) {
  /*---------------------------------------------------Hooks begin---------------------------------------------------*/
  // Translations
    ...
    <div className="container mt-50 mb-50">
      <div className="row">
        <div className="col-lg-8">
          <CommuniqueSingle Communique={Communique} translate={translate} />
        </div>
        <div className="col-lg-4 primary-sidebar sticky-sidebar">
          <div className="row mt-50 mb-25">
            {Section_Libres.map((section_libre) => (
              ...
              >
                <div className="text-center mb-50 ml-5 mr-5">
                  <div className="row">
...
export default PageCommuniqueSingle;
...
export async function getServerSideProps(context) {
  ...
  const communiqueRes = await axios.get(
    `${process.env.BASE_URL_SERVER}/api/communiques/${context["params"]["id"]}?${queryCommunique}`
  );

  // get localization communique
  findCommunique = communiqueRes["data"]["data"]["attributes"]["localizations"][
    "data"
