...
const SingleProduct = ({ product, translate }) => {
  ...
  useEffect(() => {
    ...
    if (
      wishlist != null &&
      wishlist.find((element) => element["id"] == product["id"])
    ) {
      setHeart("\u2764");
    }
  }, []);
          ...
          {product["attributes"]["exposant"]["data"] ? (
            <h2>
              <Link
                ...
                as={`/pp${product["attributes"]["exposant"]["data"]["id"]}/${product["attributes"]["exposant"]["data"]["attributes"]["slug"]}`}
              >
                <a>
                  {
          ...
          {product["attributes"]["typeprod"]["data"] ? (
            <div className="product-rate-cover">
              <Link
                ...
                as={`/p${product["attributes"]["typeprod"]["data"]["id"]}/${product["attributes"]["typeprod"]["data"]["attributes"]["slug"]}`}
              >
