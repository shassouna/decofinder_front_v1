...
function Experts({ experts }) {
  return (
    <div className="row">
      {experts.map((expert) => (
        <Link
          href={`/selection/${expert["attributes"]["selection_df"]["data"]["id"]}/${expert["attributes"]["selection_df"]["data"]["attributes"]["slug"]}`}
          key={expert["id"]}
        >
          <div className="col-lg-3 col-md-3">
            <div className="team-card">
              <img
                src={
                  expert["attributes"]["image"]["data"]
                    ? `${expert["attributes"]["image"]["data"]["attributes"]["url"]}`
